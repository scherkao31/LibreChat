...
export default function OuTravailleVotreIA() {
  ...
  return (
    <div className="ot-root">
      <style>{`
        .ot-root{min-height:100vh;background:#0a0a0b;color:#f4f4f5;overflow-x:hidden;
        ...
        .ot-kick{display:inline-flex;align-items:center;gap:9px;font-size:14px;color:#a1a1aa;letter-spacing:.06em}
        ...
        .ot-sub{font-size:clamp(15px,2vw,19px);color:#a1a1aa;max-width:560px}
        .ot-pill{display:inline-block;font-size:12px;padding:3px 10px;border-radius:999px;background:rgba(255,255,255,.08);color:#d4d4d8;margin-left:8px;vertical-align:middle}
        .ot-h1{font-size:clamp(30px,5.4vw,60px);font-weight:500;line-height:1.08;margin:36px 0 0;letter-spacing:-.02em}
        .ot-h1 em{color:#DA291C;font-style:normal}
        .ot-mid{font-size:clamp(40px,9vw,100px);font-weight:600;color:#f4f4f5;font-variant-numeric:tabular-nums;line-height:1;letter-spacing:-.02em}
        .ot-lead{font-size:clamp(20px,3.4vw,34px);font-weight:500;line-height:1.25;max-width:720px;letter-spacing:-.01em}
        .ot-lead em{color:#DA291C;font-style:normal}
        .ot-muted{color:#a1a1aa}
        .ot-bars{margin-top:22px;max-width:460px}
        .ot-barrow{display:flex;align-items:center;gap:14px;margin:12px 0;font-size:15px;color:#d4d4d8}
        .ot-barrow span:first-child{width:96px}
        .ot-track{flex:1;height:9px;border-radius:6px;background:rgba(255,255,255,.07);overflow:hidden}
        .ot-fill{height:100%;border-radius:6px;background:#DA291C;transform-origin:left;transform:scaleX(0);transition:transform 1.1s cubic-bezier(.2,.7,.2,1)}
        .ot-in .ot-fill{transform:scaleX(1)}
        ...
        .ot-details{margin-top:40px;border-top:1px solid rgba(255,255,255,.1);padding-top:24px;max-width:760px}
        .ot-details summary{cursor:pointer;font-size:15px;color:#d4d4d8}
        .ot-meth{font-size:14px;color:#a1a1aa;line-height:1.7;margin-top:14px}
        .ot-foot{padding:40px 0 64px;color:#71717a;font-size:14px}
        .ot-reveal{opacity:0;transform:translateY(24px);transition:opacity .7s ease,transform .7s ease}
        .ot-in{opacity:1;transform:none}
        .ot-hint{margin-top:54px;color:#71717a;font-size:13px;letter-spacing:.08em}
        @keyframes ot-blink{0%,100%{opacity:1}50%{opacity:.2}}
        @media(prefers-reduced-motion:reduce){.ot-root *{animation:none!important;transition:none!important}.ot-reveal{opacity:1;transform:none}.ot-fill{transform:scaleX(1)}}
      `}</style>
      ...
      <section className="ot-hero ot-sec">
        <div className="ot-wrap">
          ...
          <svg width="100%" viewBox="0 0 1000 220" style={{ marginTop: 28, maxWidth: 880 }} aria-hidden="true">
            <path d="M210 140 Q500 30 790 140" fill="none" stroke="rgba(255,255,255,.16)" strokeWidth="1.4" strokeDasharray="2 9" strokeLinecap="round">
            ...
            <rect x="78" y="116" width="118" height="48" rx="10" fill="#16171a" stroke="rgba(255,255,255,.12)" />
            ...
            <text x="120" y="145" fill="#f4f4f5" fontSize="15" fontFamily="inherit">Genève</text>
            <rect x="804" y="116" width="132" height="48" rx="10" fill="#16171a" stroke="rgba(255,255,255,.12)" />
            <text x="820" y="136" fill="#f4f4f5" fontSize="15" fontFamily="inherit">Serveurs aux</text>
            <text x="820" y="153" fill="#a1a1aa" fontSize="13" fontFamily="inherit">États-Unis</text>

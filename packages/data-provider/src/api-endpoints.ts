...
export const projectBrief = (id: string) =>
  `${projectsRoot}/${encodeURIComponent(id)}/brief`;
export const projectBriefs = (id: string) =>
  `${projectsRoot}/${encodeURIComponent(id)}/briefs`;
export const projectDebrief = (id: string) =>
...
export const projectThreads = (id: string) =>
  `${projectsRoot}/${encodeURIComponent(id)}/threads`;
export const projectCheckAgenda = (id: string) =>
  `${projectsRoot}/${encodeURIComponent(id)}/check-agenda`;
export const projectCheckEmails = (id: string) =>
  `${projectsRoot}/${encodeURIComponent(id)}/check-emails`;
